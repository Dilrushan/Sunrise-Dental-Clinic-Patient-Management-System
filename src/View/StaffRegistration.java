...
public class StaffRegistration extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(StaffRegistration.class.getName());

    public StaffRegistration() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Staff Registration - Sunrise Dental Clinic");
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, 750, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new StaffRegistration().setVisible(true));
    }
